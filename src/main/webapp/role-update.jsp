						...
						<div class="white-box">
							<form action="update-role" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="role-name" id="role-name" type="text"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="description" id="description" type="text"
											placeholder="Mô tả" class="form-control form-control-line"
											value="${role.description}" />
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<a class="btn btn-success btn-update" id-role="${role.id}">Sửa</a>
										<a href="roles" class="btn btn-primary btn-return">Quay
											lại</a>
									</div>
								</div>
							</form>
