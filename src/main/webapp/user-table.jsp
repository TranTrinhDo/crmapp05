			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="add-user" class="btn btn-sm btn-success btn-add">Thêm mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /row -->
								...
								<table class="table" id="example">
									...
									<tbody>
										...
										<tr>
											...
											<td><a name ="id"href="update-user?id=${user.id}" class="btn btn-sm btn-primary" id-user="${user.id}">Sửa</a> <a
												href="#" class="btn btn-sm btn-danger btn-xoa" id-user="${user.id}">Xóa</a> <a
												href="user-details?id=${user.id}" class="btn btn-sm btn-info btn-detail" id-user="${user.id}">Xem</a>
											</td>
										</tr>
										</c:forEach>
									</tbody>
