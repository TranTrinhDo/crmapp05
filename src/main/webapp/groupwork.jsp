			...
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="dashboard"> <b> <img
							src="plugins/images/pixeladmin-logo.png" alt="dashboard" />
					</b> <span class="hidden-xs"> <img
							src="plugins/images/pixeladmin-text.png" alt="dashboard" />
					</span>
					</a>
				</div>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="projects" class="waves-effect"><i
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="add-project" class="btn btn-sm btn-success">Thêm mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /row -->
									...
									<tbody>
										<c:forEach items="${listProject}" var="project">
											<tr>
												...
												<td><a id="id" href="update-project?id=${project.id}" class="btn btn-sm btn-primary btn-update" id-project="${project.id}">Sửa</a>
													<a href="#" class="btn btn-sm btn-danger btn-delete" id-project="${project.id}">Xóa</a> <a
													href="project-detail?id=${project.id}" class="btn btn-sm btn-info" id-project="${project.id}">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
