					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="/update-user" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input id="phone" name="phone" type="text"
											placeholder="123 456 7890" value="${user.phone}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" id="firstname" value="${user.firstName}"
											placeholder="Họ" class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" id="lastname" value="${user.lastName}"
											placeholder="Tên" class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-12">Select Role</label>
									<div class="col-sm-12">
										<select class="form-control form-control-line" id="idRole">
								...
								<div class="form-group">
									<div class="col-sm-12">
											<a class="btn btn-success btn-update" id-user="${user.id}">Cập nhật</a>
