            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="add-task" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                      <c:forEach items="${listTask}" var="task" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>
                                                <a id="id" href="update-task?id=${task.id}" class="btn btn-sm btn-primary btn-update" id-task="${task.id}">Sửa</a>
                                                <a href="#" class="btn btn-sm btn-danger btn-delete" id-task="${task.id}">Xóa</a>
                                            </td>
                                        </tr>
                                      </c:forEach>
                                    </tbody>
